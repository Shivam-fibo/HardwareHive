    ...
    >
      <div>
        ...
        <ul className="mt-6 space-y-4 text-sm">
          <li>
            <a href="#" className="text-gray-300 transition hover:opacity-75"> 1on1 Coaching </a>
          </li>
          ...
          <li>
            <a href="#" className="text-gray-300 transition hover:opacity-75"> SEO Optimisation </a>
          </li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="mt-6 space-y-4 text-sm">
          <li>
            <a href="#" className="text-gray-300 transition hover:opacity-75"> About </a>
          </li>

          <li>
            <a href="#" className="text-gray-300 transition hover:opacity-75"> Meet the Team </a>
          </li>
      ...
      <div>
        ...
        <ul className="mt-6 space-y-4 text-sm">
          <li>
            <a href="#" className="text-gray-300 transition hover:opacity-75"> Contact </a>
          </li>

          <li>
            <a href="#" className="text-gray-300 transition hover:opacity-75"> FAQs </a>
          </li>

          <li>
            <a href="#" className="text-gray-300 transition hover:opacity-75"> Live Chat </a>
          </li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="mt-6 space-y-4 text-sm">
          <li>
            <a href="#" className="text-gray-300 transition hover:opacity-75"> Accessibility </a>
          </li>

          <li>
            <a href="#" className="text-gray-300 transition hover:opacity-75"> Returns Policy </a>
          </li>
          ...
          <li>
            <a href="#" className="text-gray-300 transition hover:opacity-75"> Hiring-3 Statistics </a>
          </li>
        </ul>
      </div>
    </div>
