    ...
    <div className="bg-blue-900 text-white">
      ...
      <div className="relative text-center py-20 px-4 bg-cover bg-center" style={{ backgroundImage: "url('https://via.placeholder.com/1500x500')" }}>
        ...
        <div className="flex flex-col items-center gap-4 mt-6">
          <button className="bg-blue-500 text-white py-2 px-6 rounded-lg text-lg font-bold">LOGIN</button>
          <button className="bg-red-600 text-white py-2 px-6 rounded-lg text-lg font-bold" onClick={() => setIsModalOpen(true)}>REGISTER</button>
        </div>
      </div>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-blue-800">
          <div className="bg-blue-400 text-black p-6 rounded-lg w-96">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <button type="button" onClick={() => setIsModalOpen(false)} className="bg-gray-500 text-white w-full p-2 rounded mt-2">Cancel</button>
            </form>
          </div>
        </div>
      )}
