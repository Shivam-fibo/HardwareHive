...
function Header() {
  ...
  const contactNumber = "+91 9804611111";
  ...
  return (
    <header className="bg-white border-t-8  border-t-[#013E70]  sticky top-0 ">
      ...
      <div className=" container mx-auto px-4 sm:px-6 lg:px-8 py-3">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="order-2 md:order-1">
            <a
              href="/"
              className="text-xl lg:text-2xl  font-bold text-red-600 whitespace-nowrap"
            >
              SS Power Tool
            </a>
          </div>
          <div className="relative flex-grow min-w-0 order-4 md:order-2 w-full  md:w-auto md:max-w-lg lg:max-w-xl xl:max-w-2xl mx-auto rounded-lg">
            <input
              type="text"
              placeholder="Search"
        ...
        <div className="hidden md:flex items-center justify-center md:justify-between mt-4 pt-3 ">
          {/* Navigation Links */}
          ...
          {/* Contact Number */}
          <div className="hidden lg:block text-[#0D2F4B] font-bold text-xl ml-6 whitespace-nowrap">
            Contact No. {contactNumber}
          </div>
        </div>
        
        <div className="absolute w-[1560px] h-[4px] left-[-23px] top-[133px] bg-[#013E70] scale-y-[-1]"></div>
      </div>
